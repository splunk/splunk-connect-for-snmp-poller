...
MibEnricher = MibEnricher([{'interface_index': ['1', '2', '3']}, {'interface_desc': ['lo', 'eth0', 'eth1']}])
...
class TestHecSender(TestCase):
    ...
    def test__enrich_metric_data_index_0(self):
        ...
        variables_binds = {'metric_name': 'sc4snmp.IF-MIB.ifNumber_0', '_value': '2', 'metric_type': 'Integer'}
    ...
    def test__enrich_metric_data_index_1(self):
        fields = {'metric_name:sc4snmp.IF-MIB.ifIndex_1': '1', 'interface_desc': 'lo', 'interface_index': '1'}
        fields_initial = {'metric_name:sc4snmp.IF-MIB.ifIndex_1': '1'}
        variables_binds = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_1', '_value': '1', 'metric_type': 'Integer',
                           'interface_desc': 'lo', 'interface_index': '1'}
        variables_binds_initial = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_1', '_value': '1', 'metric_type': 'Integer'}
        _enrich_metric_data(MibEnricher, variables_binds_initial, fields_initial)
        self.assertEqual(variables_binds, variables_binds_initial)
        self.assertEqual(fields, fields_initial)

    def test__enrich_metric_data_index_2(self):
        fields = {'metric_name:sc4snmp.IF-MIB.ifIndex_2': '2', 'interface_desc': 'eth0', 'interface_index': '2'}
        fields_initial = {'metric_name:sc4snmp.IF-MIB.ifIndex_2': '2'}
        variables_binds = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_2', '_value': '2', 'metric_type': 'Integer',
                           'interface_desc': 'eth0', 'interface_index': '2'}
        variables_binds_initial = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_2', '_value': '2', 'metric_type': 'Integer'}
        _enrich_metric_data(MibEnricher, variables_binds_initial, fields_initial)
        self.assertEqual(variables_binds, variables_binds_initial)
        self.assertEqual(fields, fields_initial)

    def test__enrich_metric_data_index_3(self):
        fields = {'metric_name:sc4snmp.IF-MIB.ifIndex_3': '3', 'interface_desc': 'eth1', 'interface_index': '3'}
        fields_initial = {'metric_name:sc4snmp.IF-MIB.ifIndex_3': '3'}
        variables_binds = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_3', '_value': '3', 'metric_type': 'Integer',
                           'interface_desc': 'eth1', 'interface_index': '3'}
        variables_binds_initial = {'metric_name': 'sc4snmp.IF-MIB.ifIndex_3', '_value': '3', 'metric_type': 'Integer'}
        _enrich_metric_data(MibEnricher, variables_binds_initial, fields_initial)
        self.assertEqual(variables_binds, variables_binds_initial)
        self.assertEqual(fields, fields_initial)

    def test__enrich_event_data_index_1(self):
        variables_binds = {'metric': '{"metric_name": "sc4snmp.IF-MIB.ifDescr_1", "_value": "lo", '
                                     '"metric_type": "OctetString"}', 'metric_name': 'sc4snmp.IF-MIB.ifDescr_1',
                           'non_metric': 'oid-type1="ObjectIdentity" value1-type="OctetString" '
                                         '1.3.6.1.2.1.2.2.1.2.1="lo" value1="lo" IF-MIB::ifDescr.1="lo" '}
        variables_binds_result = 'oid-type1="ObjectIdentity" value1-type="OctetString" 1.3.6.1.2.1.2.2.1.2.1="lo" ' \
    ...
    def test__enrich_event_data_index_2(self):
        variables_binds = {'metric': '{"metric_name": "sc4snmp.IF-MIB.ifDescr_2", "_value": "eth0", '
                                     '"metric_type": "OctetString"}', 'metric_name': 'sc4snmp.IF-MIB.ifDescr_2',
                           'non_metric': 'oid-type1="ObjectIdentity" value1-type="OctetString" '
    ...
    def test__enrich_event_data_index_3(self):
        variables_binds = {'metric': '{"metric_name": "sc4snmp.IF-MIB.ifDescr_3", "_value": "eth1", '
                                     '"metric_type": "OctetString"}', 'metric_name': 'sc4snmp.IF-MIB.ifDescr_3',
                           'non_metric': 'oid-type1="ObjectIdentity" value1-type="OctetString" '
