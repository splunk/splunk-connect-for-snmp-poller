...
from splunk_connect_for_snmp_poller.manager.profile_matching import extract_desc, assign_profiles_to_device
...
class TestProfileMatching(TestCase):
    ...
    def test_return_sysdescr(self):
        realtime_collection = {
            OidConstant.SYS_DESCR: {
                "value": "Linux Suse 1.2.3.4"
            }
        }
    ...
    def test_return_sys_object_id(self):
        realtime_collection = {
            OidConstant.SYS_OBJECT_ID: {
                "value": "Some object ID"
            }
        }
